...
internal class AbilitiesBaseGenerator : Data
{
    ...
    {
        new MeasurementAbility(4, DateTime.Parse("12-02-2023"), new City("Москва")),
        new MeasurementAbility(2, DateTime.Parse("13-02-2023"), new City("Москва")),
        new MeasurementAbility(2, DateTime.Parse("14-02-2023"), new City("Москва")),
        new MeasurementAbility(2, DateTime.Parse("15-02-2023"), new City("Москва")),
        new MeasurementAbility(2, DateTime.Parse("16-02-2023"), new City("Москва")),
        new MeasurementAbility(2, DateTime.Parse("17-02-2023"), new City("Москва")),
        new MeasurementAbility(2, DateTime.Parse("18-02-2023"), new City("Москва")),
